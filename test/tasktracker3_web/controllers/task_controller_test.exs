defmodule Tasktracker3Web.TaskControllerTest do
  ...
  @create_attrs %{body: "some body", status: true, time_taken: 42, title: "some title"}
  @update_attrs %{body: "some updated body", status: false, time_taken: 43, title: "some updated title"}
  @invalid_attrs %{body: nil, status: nil, time_taken: nil, title: nil}
